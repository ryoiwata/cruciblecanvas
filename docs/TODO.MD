...
Have an option to rotate items with something sitcking out on top
Group resize

Ctrl automatically shifts back to pointer. Make shift have this option too. 
Make group select right click different
