...
- Include more colors in recent 
- Make presets more pastel colors
- Group select click should refernce all items
- Text color needs to be changed for stand alone text tool
- Fix text editing tool12
