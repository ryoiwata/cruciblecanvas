...
export default memo(function ColorLegendObject({
  ...
  // Narrow boolean selector — only re-renders when this legend's own selection state changes.
  ...
  const handleClick = (e: Konva.KonvaEventObject<MouseEvent>) => {
    ...
    if (e.evt.ctrlKey || e.evt.metaKey || useCanvasStore.getState().isMultiSelectMode) {
