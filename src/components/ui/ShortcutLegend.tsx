...
export default function ShortcutLegend() {
  return (
    <div className="fixed bottom-4 left-1/2 z-40 flex -translate-x-1/2 items-center gap-3 rounded-md bg-white/60 px-3 py-1 shadow-sm backdrop-blur-sm overflow-x-auto max-w-[calc(100vw-2rem)]">
      {shortcuts.map((s) => (
